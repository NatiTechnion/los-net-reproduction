...
def run_transferability_cross_LLMs_HD(num_epochs=10, lr=0.0001, num_seeds=5):
    ...
    imdb_sweep_map_HD_cross_models = {
        # Models: sweep_name
        'meta-llama/Meta-Llama-3-8B-Instruct': 'un2bk2ny',
        'mistralai/Mistral-7B-Instruct-v0.2': '3oblz5y6',
        'Qwen/Qwen2.5-7B-Instruct': 'kqt3y7zm'
    }
    ...
    movies_sweep_map_HD_cross_models = {
        # Models: sweep_name
        'meta-llama/Meta-Llama-3-8B-Instruct': 'am37tl28',
        'mistralai/Mistral-7B-Instruct-v0.2': '5bjduf5w',
        'Qwen/Qwen2.5-7B-Instruct': 'w2pt8eh2'
    }
    ...
    hotpotqa_sweep_map_HD_cross_models = {
        # Models: sweep_name
        'meta-llama/Meta-Llama-3-8B-Instruct': 'xt0m0lpe',
        'mistralai/Mistral-7B-Instruct-v0.2': 'uc39o6dp',
        'Qwen/Qwen2.5-7B-Instruct': '76z71022'
    }
