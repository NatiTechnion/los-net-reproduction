...
DEFAULT_BASE_RAW_DATA_DIR="/workspace/DL/proj/Beyond-next-token-probabilities/raw_data"
# Default base directory for pre-processed data
DEFAULT_BASE_PRE_PROCESSED_DATA_DIR="/workspace/DL/proj/Beyond-next-token-probabilities/preproc_data"
...
MODELS[imdb]="Qwen/Qwen2.5-7B-Instruct"
MODELS[imdb_test]="Qwen/Qwen2.5-7B-Instruct"
MODELS[movies]="Qwen/Qwen2.5-7B-Instruct"
MODELS[movies_test]="Qwen/Qwen2.5-7B-Instruct"
MODELS[hotpotqa]="Qwen/Qwen2.5-7B-Instruct"
MODELS[hotpotqa_test]="Qwen/Qwen2.5-7B-Instruct"
